...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210906172305_SeedRestforloop")]
    partial class SeedRestforloop
    {
            ...
            modelBuilder.Entity("Core.Entites.Aboutus.Aboutus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("014eec09-5f9d-4389-bb15-a16d6ddc4d0f"),
            ...
            modelBuilder.Entity("Core.Entites.Service.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("beec9a21-5719-4c25-9278-5d2631ae3c64"),
                            ActionName = "Geotechnical",
                            AddedDate = new DateTime(2021, 9, 6, 20, 23, 4, 355, DateTimeKind.Local).AddTicks(3389),
                            Content = "EditMe!",
            ...
            modelBuilder.Entity("Core.Entites.Slide.Slide", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("63d8cd56-5a4b-4ffe-bc2b-5cee768b7e65"),
                            AddedDate = new DateTime(2021, 9, 6, 20, 23, 4, 354, DateTimeKind.Local).AddTicks(5758),
                        ...
                        new
                        {
                            Id = new Guid("e3a052ca-aa15-4c50-bb19-7ca6db8b2203"),
                            AddedDate = new DateTime(2021, 9, 6, 20, 23, 4, 354, DateTimeKind.Local).AddTicks(7309),
                            SlideURL = "slide-01.jpg",
                            Text1 = "EditMe!",
                            Text2 = "EditMe!"
                        },
                        new
                        {
                            Id = new Guid("047d885b-4e97-457a-bf0f-a5009a9fca6d"),
                            AddedDate = new DateTime(2021, 9, 6, 20, 23, 4, 354, DateTimeKind.Local).AddTicks(7369),
                            SlideURL = "slide-01.jpg",
                            Text1 = "EditMe!",
                            Text2 = "EditMe!"
                        });
            ...
            modelBuilder.Entity("Core.Entites.SpecialService.SpecialService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("844182f3-3c26-447a-afe3-b362a61c9a3c"),
                            ActionName = "Geotechnical",
                            AddedDate = new DateTime(2021, 9, 6, 20, 23, 4, 355, DateTimeKind.Local).AddTicks(7290),
                            Content = "EditMe!",
            ...
            modelBuilder.Entity("Core.Entites.WebSettings.PdfFile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("096e06c6-412a-4f08-8349-1ad6b335bbbb"),
                            AddedDate = new DateTime(2021, 9, 6, 20, 23, 4, 350, DateTimeKind.Local).AddTicks(8022),
                            FileName = "EditMe!",
            ...
            modelBuilder.Entity("Core.Entites.WebSettings.WebSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2ded4f22-5449-454f-a9c1-10a816d6c43a"),
                            Adress = "EditMe!",
                            EmailAdress = "EditMe!",
                            FbAdress = "EditMe!",
